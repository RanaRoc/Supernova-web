import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-CYTGVORX.js";
import {
  firebase
} from "./chunk-HCSKTS45.js";
import {
  isPlatformServer
...
import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-ZPFHDPNT.js";
import {
  merge
} from "./chunk-CJZA4AGB.js";
import {
  Observable,
  Subject,
  filter,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-EARKEOA6.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
//# sourceMappingURL=chunk-ATZQLGY2.js.map
