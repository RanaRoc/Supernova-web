import {
  ...
  ɵfirebaseAppFactory,
  ɵlazySDKProxy
} from "./chunk-6CBH24DU.js";
import {
  firebase
} from "./chunk-I4O6BFVM.js";
import {
  isPlatformServer
} from "./chunk-BLVKPHXN.js";
import {
  Inject,
  Injectable,
  InjectionToken,
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-2Z2DB3KF.js";
import {
  merge
} from "./chunk-AUACUNWH.js";
import {
  Observable,
  Subject,
  filter,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./firebase_compat_auth.js"))), map(() => ɵfirebaseAppFactory(options, zone, name)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
//# sourceMappingURL=chunk-UO6RX2GO.js.map
